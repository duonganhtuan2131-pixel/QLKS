...
const Register = () => {
    const backendUrl = "http://localhost:3000"; // Dynamic URL would be better, but hardcoding for now
    ...
    return (
        ...
        >
            <main className="w-full max-w-lg px-4 py-12">
                {/* Brand Header */}
                ...
                <div className="glass-card rounded-2xl p-8 md:p-10 shadow-2xl">
                    <div className="text-center mb-10">
                        <h1 className="text-3xl font-semibold text-white mb-2">Đăng ký tài khoản</h1>
                        <p className="text-gray-300 text-sm">Bắt đầu hành trình của bạn ngay hôm nay</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        {/* Full Name Field */}
                        <div>
                            <label className="block text-sm font-medium text-gray-200 mb-1" htmlFor="full_name">Họ và tên</label>
                            <input 
                        ...
                        {/* Phone Field */}
                        <div>
                            <label className="block text-sm font-medium text-gray-200 mb-1" htmlFor="phone">Số điện thoại</label>
                            <input 
                                className="glass-input w-full px-4 py-3 rounded-lg text-sm" 
                                id="phone" 
                                name="phone" 
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label className="block text-sm font-medium text-gray-200 mb-1" htmlFor="password">Mật khẩu</label>
                                <input 
                                    className="glass-input w-full px-4 py-3 rounded-lg text-sm" 
                                    id="password" 
                                    name="password" 
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-200 mb-1" htmlFor="confirm_password">Xác nhận mật khẩu</label>
                                <input 
                                    className="glass-input w-full px-4 py-3 rounded-lg text-sm" 
                                    id="confirm_password" 
                    ...
                    <div className="relative my-8">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-3 bg-transparent text-gray-400">Hoặc tiếp tục với</span>
                        </div>
                    </div>
                    ...
                    <div className="mt-8 text-center text-sm">
                        <p className="text-gray-400">
                            Bạn đã có tài khoản? 
                            <Link className="text-white font-semibold hover:underline" to="/login"> Đăng nhập</Link>
                        </p>
                    </div>
                </div>
                ...
                <footer className="mt-8 text-center text-gray-500 text-xs">
                    © 2023 QuickStay International. All rights reserved.
                </footer>
            </main>
        </div>
    );
